...
const NoChatSelected = () => {
    return (
        <div className="w-full flex flex-1 flex-col items-center justify-center p-8 lg:p-16 bg-gradient-to-br from-blue-50/50 via-white/50 to-purple-50/50">
            <div className="max-w-md text-center space-y-8">
                {/* Animated Icons */}
                <div className="flex justify-center gap-4 mb-8">
                    <div className="relative">
                        <div className="w-16 h-16 lg:w-20 lg:h-20 rounded-2xl bg-gradient-to-br from-blue-100 to-blue-200 flex items-center justify-center animate-bounce">
                ...
                <div className="grid grid-cols-1 gap-4 mt-8 text-sm">
                    <div className="flex items-center gap-3 p-3 bg-white/60 rounded-xl border border-gray-200/50">
                    ...
                    <div className="flex items-center gap-3 p-3 bg-white/60 rounded-xl border border-gray-200/50">
                        ...
                        <span className="text-gray-700 font-medium">See who's online</span>
                    </div>
                    <div className="flex items-center gap-3 p-3 bg-white/60 rounded-xl border border-gray-200/50">
                        <div className="w-8 h-8 bg-purple-100 rounded-lg flex items-center justify-center">
                            <Zap className="w-4 h-4 text-purple-600" />
                        </div>
                        <span className="text-gray-700 font-medium">Share photos instantly</span>
                    </div>
                </div>
